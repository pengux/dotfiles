...
vim.api.nvim_set_keymap('n', '<leader>gf', [[<cmd>lua require('telescope.builtin').git_files({previewer = false})<CR>]], { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>sz', [[<cmd>lua require('telescope.builtin').current_buffer_fuzzy_find()<CR>]], { noremap = true, silent = true })
...
local on_attach = function(_, bufnr)
  ...
  vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>de', [[<cmd>lua require('telescope.builtin').diagnostics()<CR>]], opts)
...
-- Show virtual text for lsp diagnostics only on hover
vim.o.updatetime = 250
...
vim.api.nvim_set_keymap('n', '<leader>w', "<cmd>lua require'hop'.hint_char1({ direction = require'hop.hint'.HintDirection.AFTER_CURSOR })<cr>", {})
vim.api.nvim_set_keymap('n', '<leader>W', "<cmd>lua require'hop'.hint_char1({ direction = require'hop.hint'.HintDirection.BEFORE_CURSOR })<cr>", {})
...
golangci_lint = require("null_ls/golangci_lint")
...
require'lualine'.setup({
  ...
  sections = {
    lualine_x = {"require'lsp-status'.status()", "get_expand_tab()", 'encoding', 'fileformat', 'filetype'},
  }
})
